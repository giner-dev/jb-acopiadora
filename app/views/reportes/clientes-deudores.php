<div class="page-header">
    <div>
        <h1><i class="fas fa-arrow-down"></i> Clientes Deudores</h1>
...
<div class="rpt-stats-grid">
    <div class="rpt-stat-card">
        ...
        <div class="rpt-stat-info">
            <span class="rpt-stat-label">Clientes Deudores</span>
    ...
    <div class="rpt-stat-card rpt-stat-monto-debe">
        ...
        <div class="rpt-stat-info">
            <span class="rpt-stat-label">Monto Total en Deuda</span>
        ...
        <?php else: ?>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="rpt-valor-debe"><strong>Bs <?php echo number_format($cliente['saldo'], 2); ?></strong></td>
                            <td>
            ...
            <div class="pagination-wrapper">
                ...
                <div class="pagination">
                    <?php if ($page > 1): ?>
                        <a href="<?php echo url('reportes/clientes-deudores?page=' . ($page - 1)); ?>" class="pagination-link"><i class="fas fa-chevron-left"></i> Anterior</a>
                    <?php endif; ?>
                    <?php
                    $startPage = max(1, $page - 2);
                    $endPage   = min($totalPages, $page + 2);
                    if ($startPage > 1): ?>
                        <a href="<?php echo url('reportes/clientes-deudores?page=1'); ?>" class="pagination-link">1</a>
                        <?php if ($startPage > 2): ?><span class="pagination-dots">...</span><?php endif; ?>
                    <?php endif; ?>
                    <?php for ($i = $startPage; $i <= $endPage; $i++): ?>
                        <a href="<?php echo url('reportes/clientes-deudores?page=' . $i); ?>" class="pagination-link <?php echo $i === $page ? 'active' : ''; ?>"><?php echo $i; ?></a>
                    <?php endfor; ?>
                    <?php if ($endPage < $totalPages): ?>
                        <?php if ($endPage < $totalPages - 1): ?><span class="pagination-dots">...</span><?php endif; ?>
                        <a href="<?php echo url('reportes/clientes-deudores?page=' . $totalPages); ?>" class="pagination-link"><?php echo $totalPages; ?></a>
                    <?php endif; ?>
                    <?php if ($page < $totalPages): ?>
                        <a href="<?php echo url('reportes/clientes-deudores?page=' . ($page + 1)); ?>" class="pagination-link">Siguiente <i class="fas fa-chevron-right"></i></a>
                    <?php endif; ?>
                </div>
            </div>
            <?php endif; ?>
