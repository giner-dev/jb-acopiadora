<div class="page-header">
    <div>
        <h1><i class="fas fa-seedling"></i> Nuevo Acopio</h1>
        <p>Registra una nueva entrega de cosecha</p>
    </div>
    <div>
...
<form action="<?php echo url('acopios/guardar'); ?>" method="POST" id="formAcopio">
    <input type="hidden" name="detalles_json" id="acopio_detalles_json">
    <input type="hidden" name="cliente_id" id="acopio_cliente_id_hidden">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="codigo_manual">
                                ...
                                Número de Acopio (Opcional)
                            </label>
                            <input 
                                type="text" 
                                id="acopio_codigo_manual" 
                                name="codigo_manual" 
                                class="form-control" 
                            ...
                            <small class="text-muted">
                                Ingresa solo el número (ej: <?php echo $proximoNumero; ?>). 
                                Se generará automáticamente: ACO<?php echo str_pad($proximoNumero, 6, '0', STR_PAD_LEFT); ?>
                            </small>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div id="acopio_cliente_display">
                                <span id="acopio_cliente_seleccionado"></span>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo url('acopios'); ?>" class="btn btn-secondary btn-block">
                        <i class="fas fa-times"></i>
                        Cancelar
                    </a>
                </div>
...
<!-- MODAL AGREGAR CANTIDAD Y PRECIO -->
